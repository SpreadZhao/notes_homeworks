...
description: 
link: 
tags: #question/coding/android,#language/coding/kotlin,#language/coding/java,#question/coding/practice,#question/coding/theory,#question/interview,#rating/high
---

#question/coding/android #language/coding/kotlin #language/coding/java #question/coding/practice #question/coding/theory #question/interview #rating/high 
...
- [i] **为什么我们能在主线程直接使用 Handler，而不需要创建 Looper ？**
...
- [i]  **Handler、Thread和HandlerThread的差别**
...
- [i] **Message 的插入以及回收是如何进行的，如何实例化一个 Message 呢？**
...
- [i] **妙用Looper机制，或者你知道Handler机制的其他用途吗？**
...
- [i] **Looper.loop()死循环一直运行是不是特别消耗CPU资源呢？不会造成应用卡死吗？**
...
- [i] **MessageQueue 中如何等待消息？为何不使用 Java 中的 wait/notify 来实现阻塞等待呢？**
